// Screens/ReflectionReadingScreen.jsx
...
// MAIN COMPONENT
// ============================================
export default function ReflectionReadingScreen({ route, navigation }) {
  ...
  const loadReading = () => {
    const foundReading = reflectionData.find(
    ...
    if (foundReading) {
      ...
      setReading({
        ...
        practice: "Take a few deep breaths and return to this practice tomorrow.",
        category: "meditation",
      });
    }
  };
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            ...
            <Text style={styles.headerSubtitle}>MINDFULNESS PRACTICE</Text>
          </View>
          ...
          >
            ...
            {reading.practice && (
              <>
                ...
                <Text style={[styles.practiceLabel, { color: THEME.accentPrimary }]}>
                  TODAY'S PRACTICE
                </Text>
                <Text style={styles.practiceText}>{reading.practice}</Text>
              </>
            )}

            <Text style={styles.source}>— Recovery Dharma</Text>
          </LinearGradient>
        </ScrollView>
...
// ============================================
// STYLES - EXACT MATCH WITH CAPTAIN'S AMENDMENTS
// ============================================
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingTop: Platform.OS === 'android' ? 50 : 10,  // CAPTAIN'S FIX
    paddingBottom: 12,
  },
  backButton: {
    width: 44,
  ...
  // ============================================
  // PRACTICE SECTION (unique to meditation)
  // ============================================
  practiceDivider: {
    height: 1,
