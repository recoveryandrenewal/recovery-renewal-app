// Screens/BuddhistReadingScreen.jsx
...
export default function BuddhistReadingScreen({ route, navigation }) {
  ...
  const loadReading = (month, day) => {
    const entry = dhammapadaData.find(
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            ...
            <Text style={styles.headerSubtitle}>Buddhist Wisdom</Text>
          </View>
          ...
          >
            ...
            <View style={styles.verseContainer}>
              <Text style={styles.verseTitle}>
                Dhammapada {reading.chapter}:{reading.verse}
              </Text>
