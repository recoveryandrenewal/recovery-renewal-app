        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.textWrapper}>
            ...
            <Text style={styles.quote}>
              Breathe and grow, one day at a time,{'\n'}
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#0F0F1B', // Fallback color
  },
  safeArea: {
    flex: 1,
  },
  ...
  textWrapper: {
    // Removed background color to let text float on stars
    padding: 20,
    width: '100%',
    maxWidth: 500,
    alignItems: 'center',
  ...
  emphasis: {
    fontSize: 24,
    fontWeight: 'bold',
    color: '#ec4899', // Pink preserved
    marginBottom: 8,
    textAlign: 'center',
    textShadowColor: 'rgba(236, 72, 153, 0.3)', // Subtle glow matching color
  ...
  button: {
    ...
    borderRadius: 30, // More rounded pill shape to match other buttons
    alignItems: 'center',
    shadowColor: '#ec4899',
